<template>
    <div v-transfer-dom :data-transfer="transfer">
        ...
        <div class="my-modal" :class="wrapClasses" @click="handleWrapClick">
...
<style lang="less">
  ...
  .my-modal {
    .ivu-modal-content {
      ...
      .ivu-modal-header {
        border-bottom-color: @color-Tangerine;
        padding: 10px;
      ...
      .ivu-modal-footer {
        border-top-color: @color-Tangerine;
        .ivu-btn {
